...
On a clear verdict it prints one operator-facing clause to stderr naming what it checked and what it did not, every time rather than only on a failure, because the spawn discards its stdout and a clean verdict is when the unexamined part matters most.
