...
description: >-
  ...
  Use before spawning or recovering a crewmate or secondmate, handling a trust dialog or a worker permission prompt, sending a harness-specific skill invocation, interrupting or exiting an agent, resuming an exited agent, or verifying a new harness adapter.
...
Kimi establishes its unsupported primary boundary in its selected harness reference; Muse, Gemini, rovo, and AGY follow Non-negotiable safety above.
