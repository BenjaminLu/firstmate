...
CHECK_TIMEOUT=${FM_CHECK_TIMEOUT:-60}     # seconds allowed per *.check.sh; the
                                      # contribution poll is the longest one and
                                      # needs its whole forge budget to fit here
                                      # (bin/fm-contributions.sh, default 45)
