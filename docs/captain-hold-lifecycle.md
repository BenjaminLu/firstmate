...
On a scout that remedy names the captain-call completion gate ahead of cleanup, because a scout is the one kind where cleanup has a prerequisite of its own and a remedy naming only cleanup would be refused in turn.
