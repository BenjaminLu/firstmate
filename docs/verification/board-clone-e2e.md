...
This is the board's only end-to-end suite: the file that previously carried that name guarded an external presentation tool, reported a capability skip in CI, and was deleted when the board stopped needing that tool.
