...
When that poll returns a merged verdict, the watcher records the commit the merge landed and then routes the outcome through the shared merge-outcome emitter before retiring the poll.
