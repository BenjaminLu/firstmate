...
| `fm-pr-merge.sh`         | Record PR metadata, refuse a merge no reviewer approved at the head, merge a task's canonical full GitHub or GitLab URL, then refuse an outcome it cannot prove landed or queued |
