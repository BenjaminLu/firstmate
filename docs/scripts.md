...
| `fm-packet.sh`           | Scaffold, verify, and render the worker's decision packet beside its task, serve the page with Lavish, and compose the board's five-question card from it |
