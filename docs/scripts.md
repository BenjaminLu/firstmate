...
| `fm-bearings-board.sh`   | Compose the trilingual payload skeleton, build and arm the stable `/bearings lavish` fleet board, and carry the acknowledgement a captain's click leaves on its row |
