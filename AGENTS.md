...
config/remote-board  address of this home's remote bearings board, one line; LOCAL, gitignored; absent = this home has no remote board; not inherited by secondmate homes; see docs/configuration.md "Remote bearings board"
...
Load it too before building or changing any surface that presents the bearings board, such as a remote copy, an export, or a mirror; the board has one definition and every other surface is derived from it.
