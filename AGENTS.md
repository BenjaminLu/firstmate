...
state/               runtime records and signals; gitignored
  ...
  board-acks/        what the captain clicked on the Bearings board and has not yet seen the consequence of, one record per board key; written only by bin/fm-bearings-board.sh ack, recorded at answer capture and settled by the handler as a dispatch or a refusal
