...
render_board() {  # <home> <underway-json> <charted-json> [charted_more] [charted_warning_more]
  ...
  jq -n --argjson underway "$underway" --argjson charted "$charted" \
    ...
    schema:"fm-bearings-board.v1", home:"render-home", generated:"2026-08-26T00:00Z", composed:"2026-08-26T00:00:00Z",
...
five_question_payload() {  # <lang>
  jq -n --arg lang "$1" '{
    schema:"fm-bearings-board.v1", home:"render-home", generated:"2026-09-18T00:00Z", composed:"2026-09-18T00:00:00Z",
...
test_hans_absent_falls_back_to_hant_not_empty() {
  ...
  payload=$(jq -n '{
    schema:"fm-bearings-board.v1", home:"render-home", generated:"2026-09-19T00:00Z", composed:"2026-09-19T00:00:00Z",
