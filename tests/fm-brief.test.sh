...
test_ship_and_scout_carry_the_machine_boundary_rules() {
  ...
  brief="$home/data/brief-boundary-scout/brief.md"
  assert_no_grep "laboratory - install, run, edit" "$brief" "scout brief still invites unbounded installs"
